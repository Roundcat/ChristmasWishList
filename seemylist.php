    ...
    <div class="container">
      ...
      <div class="site_body">
            ...
            <div class="row">
              ...
              <p><strong><?php echo ($user['userfirstname']); ?></strong>, retrouvez toutes vos listes ci-dessous.</p>
              </div>
                    ...
                    <tbody>
                      ...
                      while($donnees = $reponse->fetch()) { ?>
                        <tr>
                          ...
                          <td><?php echo('<a href="seemydetaillist.php?listid=' . $donnees['listeid'] . '">' . htmlspecialchars($donnees['libelleliste']) . '</a>'); ?></td>
